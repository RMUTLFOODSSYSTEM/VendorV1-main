...
export default function Complaint() {
  ...
  const [complaints, setComplaints] = useState([
    {
      ...
      detail: "ระบบไม่อัปเดตสถานะการชำระเงิน",
      status: "รอดำเนินการ",
    },
  ]);
  ...
  return (
    <div className="container py-4">
      <h2 className="fw-bold text-success mb-4">ร้องเรียนปัญหา (ร้านค้า)</h2>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-3">
              ...
              >
                ...
                <option value="ลูกค้ายกเลิกออเดอร์">ลูกค้ายกเลิกออเดอร์</option>
                <option value="การแจ้งเตือนไม่ทำงาน">การแจ้งเตือนไม่ทำงาน</option>
